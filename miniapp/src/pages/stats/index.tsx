...
function StatsPage(): JSX.Element {
  ...
  return <View className="page stats-page">
    <PageHeader title="贡献统计" description="这里统计 Coboard 任务/贡献点数，不是 Syna币，也不是可消费余额。" action={(isAdmin || isManager) ? <ActionButton tone="secondary" size="small" onClick={() => void exportCsv()}>导出</ActionButton> : undefined} />
